...
const updateUserInfo = (req, res) => {
  ...
  const update_query = {
    text: `UPDATE users SET name='${data.name}', birthday='${data.birthday}', height='${data.height}', weight='${data.weight}', waist='${data.waist}', blood_pressure='${data.blood_pressure}', updated_at='${updated_at}' WHERE name='${data.name}' AND birthday='${data.birthday}' AND delete_flg=0;`
  };
